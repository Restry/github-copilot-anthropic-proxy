...
export const MODEL_REGISTRY_FALLBACK = [
  ...
  { id: "gpt-5.6-terra",  display_name: "GPT-5.6 Terra",   created_at: "2026-07-01", provider: "openai", protocol: "openai" },
  { id: "gpt-5.6-sol",    display_name: "GPT-5.6 Sol",     created_at: "2026-07-01", provider: "openai", protocol: "openai" },
  { id: "gpt-5.6-luna",   display_name: "GPT-5.6 Luna",    created_at: "2026-07-01", provider: "openai", protocol: "openai" },
